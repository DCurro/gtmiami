...
RevolverDescriptor::RevolverDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_REVOLVER;
}

RevolverDescriptor::~RevolverDescriptor() {
    
}

rapidjson::Value* RevolverDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {

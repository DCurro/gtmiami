...
RocketLauncherDescriptor::RocketLauncherDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_ROCKETLAUNCHER;
}

RocketLauncherDescriptor::~RocketLauncherDescriptor() {
    
}

rapidjson::Value* RocketLauncherDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {

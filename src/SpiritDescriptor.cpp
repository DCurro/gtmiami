...
SpiritDescriptor::SpiritDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_SPIRIT;
}

SpiritDescriptor::~SpiritDescriptor() {
    
}

rapidjson::Value* SpiritDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {

...
ZombieDescriptor::ZombieDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_ZOMBIE;
}

ZombieDescriptor::~ZombieDescriptor() {
    
}

rapidjson::Value* ZombieDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {

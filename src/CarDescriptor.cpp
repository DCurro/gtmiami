...
CarDescriptor::CarDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_CAR;
}
...
rapidjson::Value* CarDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {

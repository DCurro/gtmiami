...
TurretDescriptor::TurretDescriptor(int uniqueReferenceId, int floor, float x, float y, float angle)
: PooledPlayEntityDescriptor(uniqueReferenceId, floor, x, y, angle)
{
    this->mPOOLEDPLAYENTITY_TYPE = POOLEDPLAYENTITY_TYPE_TURRET;
}

TurretDescriptor::~TurretDescriptor() {
    
}

rapidjson::Value* TurretDescriptor::descriptorJsonObjectValue(rapidjson::Document* jsonDoc) {
